...
| [kelvin-helmholtz.py](kelvin-helmholtz.py) | Kelvin–Helmholtz shear-layer instability: three density/velocity bands with a sinusoidal velocity perturbation, evolved with `GridHydroKT2d` and periodic boundaries, dumped to Silo |
